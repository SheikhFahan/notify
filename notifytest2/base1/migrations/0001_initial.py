    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('questionPaper', models.FileField(null=True, upload_to='pdf/question_papers/')),
                ('sub_code', models.ManyToManyField(to='base1.subcode')),
            ],
        ),
        migrations.CreateModel(
            name='Professor',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.FileField(null=True, upload_to='pdf/notes/')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment', models.FileField(null=True, upload_to='pdf/assignments/')),
                ('prof', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='base1.professor')),
                ('sub_code', models.ManyToManyField(to='base1.subcode')),
            ],
        ),
